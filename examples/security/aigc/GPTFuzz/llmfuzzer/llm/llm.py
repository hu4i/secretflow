...
class ClaudeLLM(LLM):
    def __init__(self, model_path="claude-instant-1.2", api_key=None, base_url=None):
        super().__init__()
    ...
    def generate(self, prompt, temparture=0, max_tokens=512, n=1, max_trials=1, failure_sleep_time=5):
